...
## Overview
This is a personal website that I made for my Web Development class. Made using HTML and CSS, it includes a home page, a projects page, a resume page, and a "fun stuff" page.
...
The site is deployed using GitHub Pages and can be viewed directly in a web browser. The link above leads to that. 
